...
const menuData = { 
    ...
    specials: {
        ...
        linkUrl: '/customs', // 👈 SET CUSTOMS ROUTE PATH
...
function App() {
    ...
    return (
        <>
            <main>
                <section id="welcome" className={`animated-element ${animate ? 'slide-in-up' : ''}`} style={{ animationDelay: '0.7s' }}>
                    <h2>Handcrafted Goodness, Made Daily</h2>
                    <p>Welcome to Yetta's, where every bite is a celebration! Explore our delightful selection of baked goods and frozen treats below.</p>
                </section>
